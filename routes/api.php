...
// })->name('api.calendar');
Route::get('calendar', [FullCalendarController::class, 'index'])->middleware('auth:api')->name('api.calendar.index');
Route::get('calendar/action', [FullCalendarController::class, 'index'])->middleware('auth:api')->name('api.calendar.index');
Route::post('calendar/action', [FullCalendarController::class, 'action'])->middleware('auth:api')->name('api.calendar.action');
