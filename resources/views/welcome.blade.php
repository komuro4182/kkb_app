        ...
        <div
            ...
            <div class="h-full flex flex-auto bg-purple-900 text-white bg-no-repeat bg-cover relative bg-image">
                <div
                    ...
                    <div {{-- class="absolute bg-gradient-to-b from-indigo-900 to-orange opacity-75 inset-0 z-0"></div> --}}
                        class="absolute .original-gradient {height: 200px; width: 90%;background-image: radial-gradient(circle, rgba(255, 242, 58, 1), rgba(224, 162, 8, 1) 80%);
                        }">
                    </div>
